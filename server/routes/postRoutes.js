...
router.get('/group/:groupId/random', authMiddleware, PostController.getRandomPost);
router.get('/group/:groupId/memories', authMiddleware, PostController.getMemoriesData);
